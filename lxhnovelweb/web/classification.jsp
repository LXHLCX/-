        ...
        <div id="hotcontent">
            <div class="l" style="height: 100%;width: 1043px">
                <%
                    ...
                    Integer classification=Book.classificationStringToClassificationInteger(classificationString);
                    if(classification==null){
                        out.print("<script type='text/javascript'>");
                        out.print("alert('没有指定分类');");
                        out.print("window.location='index.jsp';");
                        out.print("</script>");
                        return;
                    }
                    ArrayList<Book> bookArrayList=new BookDAO().getANumberOfBooksByClassification(-1,classification);
