...
function login() {
    ...
    document.writeln("<div class=\"ywtop\"><div class=\"ywtop_con\"><B>公告：</B>书友们，“笔趣阁”最新域名“www.5ibiquge.com”。请您牢记本站网址并加入收藏，手机也可直接访问，会自动进入手机站！</span>");
...
function footer() {
    ...
    document.writeln("<p>如果版权人认为在本站放置您的作品有损您的利益，请发邮件至1031908340@qq.com，本站确认后将会立即删除。</p>");
    document.writeln("<p>Copyright &copy; 2010-2017 笔趣阁 All Rights Reserved.</p>");
...
function read_panel() {
    showsearch();
    document.writeln("<div class=\"userpanel\">&nbsp;<font color=\"red\">笔趣阁手机站<br>http://m.5ibiquge.com</font></div>");
}
